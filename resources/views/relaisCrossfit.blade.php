...
<head>
    ...
    initial-scale=1.0">
    <title>Relais Crossfit - URCA Games 2024</title>
    ...
    <main>
        ...
        ?>
            ...
            <x-sport title="Relais Crossfit"
                ...
                image="img/crossfit.png" :rules="$rulesArray" :searchable="true" :striped="true" exclude_columns="id"
