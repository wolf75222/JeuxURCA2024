...
<head>
    ...
    initial-scale=1.0">
    <title>Palets Bretons - URCA Games 2024</title>
    ...
    <main>
        ...
        ?>
            ...
            <x-sport title="Palets bretons"
                ...
                image="img/palet.png" :rules="$rulesArray" :searchable="true" :striped="true" exclude_columns="id"
