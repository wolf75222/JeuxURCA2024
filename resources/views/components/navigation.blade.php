    ...
    justify-between mx-auto p-4"> <a href="#" class="flex items-center"> <img
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul
                ...
                <li>
                    <a href="/classement"
                        class="block py-2 pl-3 pr-4 {{ Request::is('classement') ? 'text-blue-500' : 'text-gray-900 dark:text-white' }} rounded md:hover:bg-transparent md:hover:text-blue-500 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Classement</a>
                </li>
                <li>
                    <a href="/equipe"
                        class="block py-2 pl-3 pr-4 {{ Request::is('equipe') ? 'text-blue-500' : 'text-gray-900 dark:text-white' }} rounded md:hover:bg-transparent md:hover:text-blue-500 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Équipe</a>
                </li>
                <li>
                    <a href="/sports"
                        class="block py-2 pl-3 pr-4 {{ Request::is('sports') ? 'text-blue-500 dark:text-blue-500' : 'text-gray-900 dark:text-white' }} rounded md:hover:bg-transparent md:hover:text-blue-500 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Sport</a>
                </li>
                <li>
                    <a href="/regles"
                        class="block py-2 pl-3 pr-4 {{ Request::is('regles') ? 'text-blue-500  dark:text-blue-500' : 'text-gray-900 dark:text-white' }} rounded md:hover:bg-transparent md:hover:text-blue-500 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Règles</a>
                </li>
            </ul>
