{{-- resources/views/components/modals/event-modal.blade.php --}}

<!-- Status : factorisation -->

<!-- Edit event modal pour l'utilisateur {{ $event->id }} -->
<div id="editEventModal-{{ $event->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-close="editEventModal-{{ $event->id }}">
