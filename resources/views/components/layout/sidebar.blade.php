          ...
          <form action="#" method="GET" class="md:hidden mb-2">
            ...
            <div class="relative">
              <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                <svg class="w-5 h-5 text-blue-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20"
          ...
          <ul class="space-y-2">
            ...
            <li>
              <button type="button"
                ...
                <svg aria-hidden="true"
                  class="flex-shrink-0 w-6 h-6 text-blue-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
                    d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z"
                    clip-rule="evenodd"></path>
                </svg>
                <span class="flex-1 ml-3 text-left whitespace-nowrap">Gérer</span>
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                ...
                <li>
                  <a href="#"
                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Classements</a>
                </li>
                <li>
