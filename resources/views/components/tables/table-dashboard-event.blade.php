        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 flex items-center">
                    ...
                    <a href="/dashboard/events/{{ $event->id }}/phase" class="ml-3" >
                        <svg class="w-5 h-5 text-green-600 dark:text-gray-400 hover:text-green-800 dark:hover:text-gray-300" aria-hidden="true"
